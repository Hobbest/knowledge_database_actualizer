...
from app.vault import VaultNote, load_note
...
class ChromaVectorStore:
    ...
    def upsert_notes(self, vault_path: Path, relative_paths: list[str]) -> dict[str, Any]:
        ...
        if settings.transclude_depth > 0:
            ...
            from app.vault import load_vault
    ...
    def _delete_note_chunks(self, note_path: str) -> None:
        try:
            ...
            self._delete_chunks_by_note_path(note_path)
...
# Backward-compatible alias used across tests and scripts.
